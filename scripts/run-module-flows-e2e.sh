...
required_vars="CYPRESS_CMS_ADMIN_EMAIL CYPRESS_CMS_ADMIN_PASSWORD"
...
npx start-server-and-test \
  ...
  "npx start-server-and-test preview http://localhost:4173 \"cypress run --e2e --spec cypress/e2e/module-resource-flows.cy.js\""
